...
export default function WbrEditPage() {
  ...
  return (
    <div className="max-w-7xl mx-auto space-y-10 pb-20 pt-4 px-4">
      ...
      <AddActionItemDialog isOpen={isActionDialogOpen} onOpenChange={setIsActionDialogOpen} clientId={actualClientId} clientName={clientInfo?.name} action={selectedAction} />
    </div>
  );
}
