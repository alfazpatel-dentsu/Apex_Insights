                  ...
                  <TableCell className="px-6">
                    <DropdownMenu>
                      ...
                      <DropdownMenuContent align="end" className="rounded-xl glass border-none shadow-2xl p-2 min-w-[140px]">
                        <DropdownMenuItem className="rounded-lg text-[10px] font-black uppercase tracking-widest gap-2" onClick={() => { setSelectedLead(lead); setIsDialogOpen(true); }}>
                          <ArrowRight className="h-3 w-3" /> Edit Details
                        </DropdownMenuItem>
                        <DropdownMenuItem className="rounded-lg text-[10px] font-black uppercase tracking-widest text-destructive gap-2 focus:bg-destructive/10 focus:text-destructive" onClick={() => setDeletingId(lead.id)}>
