                    ...
                    <TableCell className="text-right pr-8">
                      <DropdownMenu>
                        ...
                        <DropdownMenuContent align="end" className="rounded-none border-ink bg-white shadow-2xl p-1 min-w-[160px]">
                          ...
                          <DropdownMenuItem className="rounded-none text-xs font-black uppercase flex items-center gap-2 px-3 py-2 cursor-pointer focus:bg-cream" onClick={() => { setSelectedUserForEdit(user); setIsEditUserDialogOpen(true); }}>
                            <Eye className="h-4 w-4" /> MANAGE ACCESS
                          </DropdownMenuItem>
                          <DropdownMenuItem className="rounded-none text-xs font-black uppercase text-destructive flex items-center gap-2 px-3 py-2 cursor-pointer focus:bg-destructive/10" onClick={() => setUserToDelete(user)}>
