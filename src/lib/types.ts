...
/** Client account — discovered from KPI/Spend records or the clients collection. */
...
/** KPI definition used by the tracker dialog dropdowns. */
export interface Kpi {
    id: string;
    name: string;
}

/** Channel definition used by the tracker dialog dropdowns. */
