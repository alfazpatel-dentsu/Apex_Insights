...
| Cloud Functions (email alerts) | Optional | `functions/` — **1st gen** Graph mail from `aztec_alerts@dentsu.com` (codebase name `action-items-sheets`); see `functions/README.md` |
