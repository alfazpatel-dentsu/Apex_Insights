...
| Email automations | Optional | Same Functions codebase — alerts from `aztec_alerts@dentsu.com` (task overdue, access granted, etc.); requires `SMTP_PASS` secret; app URL `https://azteccontrolcenter.dentsu.com` |
